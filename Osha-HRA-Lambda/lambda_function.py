...
HRA_CHECKLIST = {
    ...
    "categories": [
        ...
        },
        {
            ...
            "name": "Fleet",
            "items": [
                {"id": 8, "description": "The Branch Manager is able to produce a current and valid copy of the vehicle insurance card required to be carried in all Continental Battery Systems’ owned and leased vehicles.", "answer": "", "finding": "", "action_item": "", "responsible": "", "due_date": "", "evidence": []},
